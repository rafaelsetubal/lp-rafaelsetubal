    ...
    <section id="servicos" className="py-24 md:py-32 border-t border-[rgba(17,17,17,0.10)] bg-transparent relative z-10">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 mb-16 md:mb-20 items-end">
          <Reveal className="md:col-span-7">
            ...
            <h2 className="font-heading text-[2rem] sm:text-[2.5rem] md:text-[2.85rem] font-semibold tracking-[-0.03em] leading-[1.08] text-[#111111]">
              <TextReveal>Soluções para cada etapa do seu negócio.</TextReveal>
            </h2>
          </Reveal>
          <Reveal className="md:col-span-5 md:pl-6" delay={200}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 md:gap-y-0 pt-12 pb-12 border-t border-b border-[rgba(17,17,17,0.10)]">
          ...
          {/* Service 01 */}
          <Reveal className="md:col-span-4 md:pr-8 lg:pr-12 flex flex-col justify-between" delay={0}>
            <div>
              <span className="font-sans text-xs md:text-sm font-medium text-[#8A8F98] block mb-5">01</span>
              <h3 className="font-heading font-semibold text-xl md:text-[1.35rem] text-[#111111] mb-3 tracking-tight">Landing Page</h3>
            ...
            <div>
              <Link href="#contato" className="font-sans font-medium text-sm text-[#3D6AFF] hover:text-[#2F59E8] transition-colors inline-flex items-center gap-1 group">
          ...
          {/* Service 02 */}
          <Reveal className="md:col-span-4 md:px-8 lg:px-12 md:border-l md:border-[rgba(17,17,17,0.10)] flex flex-col justify-between" delay={150}>
            <div>
              <span className="font-sans text-xs md:text-sm font-medium text-[#8A8F98] block mb-5">02</span>
              <h3 className="font-heading font-semibold text-xl md:text-[1.35rem] text-[#111111] mb-3 tracking-tight">Site Institucional</h3>
              <p className="font-sans text-sm md:text-[0.9375rem] text-[#5F6368] leading-relaxed mb-8 font-normal">
          ...
          {/* Service 03 */}
          <Reveal className="md:col-span-4 md:pl-8 lg:pl-12 md:border-l md:border-[rgba(17,17,17,0.10)] flex flex-col justify-between" delay={300}>
            <div>
              <span className="font-sans text-xs md:text-sm font-medium text-[#8A8F98] block mb-5">03</span>
              <h3 className="font-heading font-semibold text-xl md:text-[1.35rem] text-[#111111] mb-3 tracking-tight">Projeto Específico</h3>
              <p className="font-sans text-sm md:text-[0.9375rem] text-[#5F6368] leading-relaxed mb-8 font-normal">
