    ...
    <section id="processo" className="py-16 md:py-24 border-t border-[var(--line-subtle)]">
      <div className="max-w-[1160px] mx-auto px-6 grid lg:grid-cols-12 gap-10 lg:gap-20 items-center">
        <div className="lg:col-span-5 lg:col-start-8 lg:row-start-1">
          ...
          <h2 className="font-heading text-[2.5rem] sm:text-5xl lg:text-[3.4rem] font-semibold tracking-[-.04em] leading-[1.04]">Sua ideia.<br />Um caminho claro.<br /><span className="text-[#3D6AFF]">Seu site no ar.</span></h2>
        ...
        <ol className="lg:col-span-6 lg:col-start-1 lg:row-start-1 relative">
          {steps.map(([title, text], index) => (
            <li key={title} className="relative grid grid-cols-[48px_1fr] sm:grid-cols-[60px_1fr] gap-4 sm:gap-6 pb-6 last:pb-0">
